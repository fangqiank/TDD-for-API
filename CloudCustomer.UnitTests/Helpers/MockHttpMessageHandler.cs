...
namespace CloudCustomer.UnitTests.Helpers
{
    ...
    {
        public static Mock<HttpMessageHandler> SetupBasicResourceList(
            List<T> expectedResponse
        )
        {
            ...
            mockResponse.Content.Headers.ContentType = new
        ...
        internal static Mock<HttpMessageHandler> SetupBasicResourceList(
